...
func _ready():
	...
	var label_blank2 = Label.new()
	if best_time < 0:
		label_blank2.text = " "
	else:
		label_blank2.text = str(best_time, "s")
	#levels_grid.add_child(label_blank2)
	var label_blank3 = Label.new()
	label_blank3.text = " "
	#levels_grid.add_child(label_blank3)
